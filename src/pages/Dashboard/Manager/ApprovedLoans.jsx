...
import { FiEye, FiDollarSign, FiCheckCircle } from 'react-icons/fi';
                  ...
                  <tr key={app._id}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                      {app.repaymentStatus === 'Complete' ? (
                        ...
                        <div>
                          <div className="text-xs">Paid: ${(app.paidAmount || 0).toLocaleString()}</div>
                          <div className="text-xs">Remaining: ${(app.remainingAmount || app.totalAmount || app.loanAmount).toLocaleString()}</div>
                        </div>
                      ) : (
